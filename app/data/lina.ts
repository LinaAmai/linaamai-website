export const lina = {
  ...
  description:
    "Lina Amai é uma AI Idol, artista musical e presença digital brasileira que conecta pessoas por meio da música, da arte e da inteligência artificial.",

  officialWebsite: "https://linaamai.com",

  image: "https://linaamai.com/images/lina-amai-profile.jpg",
  ...
  affiliation: {
    name: "AIBrasil.AI",
    url: "https://galeria.aibrasil.ai/",
    role: "Embaixadora",
  },

  press: [
    {
      title: "Lina Amai — A embaixadora de uma nova geração",
      publisher: "Juliano Kimura",
      url: "https://www.julianokimura.com.br/p/lina-amai-a-embaixadora-de-uma-nova",
    },
  ],
};